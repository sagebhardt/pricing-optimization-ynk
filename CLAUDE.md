...
- `scripts/compare_models.py` — benchmarks XGBoost vs LightGBM vs CatBoost on holdout
  - Usage: `python scripts/compare_models.py HOKA` or `--all`
  - Result: LightGBM wins regressor on 3/4 brands, classifier is near-perfect on all frameworks
